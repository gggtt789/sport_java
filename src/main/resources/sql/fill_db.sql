...
VALUES
('event1', 'venue1', 'result1', '2021-01-01'),
...
INSERT INTO seats(name, price, total_number, available_number)
VALUES
('seat3', 3333, 333, 33);
...
GRANT ALL ON ALL TABLES IN SCHEMA public TO sport_admin;
GRANT ALL ON ALL SEQUENCES IN SCHEMA public TO sport_admin;
